...
button_blance=Button(root,text="Balance",font='comicsansms 19 bold',borderwidth=10,relief="ridge" ,justify="center",width=25,command=lambda:display(3)).place(x=250,y=400)
