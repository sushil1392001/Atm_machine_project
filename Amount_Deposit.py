...
def depoit_note_detail(numnoteuser,notes):
    for i in range(0,4):
            ...
            mysql.execute(new_numNote,t)
            conn.commit()
    # my1.config(text="***** successfully deposite *****")
    msg.showinfo("successfully","successfully deposite")
...
Label(root,text="Amount Deposite",font="Arial 25 bold",borderwidth=49,relief="groove",justify="center",background="#208ff7",width=40).place(x=300,y=10)
